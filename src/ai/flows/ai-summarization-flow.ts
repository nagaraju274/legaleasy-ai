...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert legal summarizer.  Your job is to provide a concise, plain English summary of a legal document so that a layperson can quickly understand the key points.
